...
for all test cases, makes sure code still runs, even if the movie object doesn't have that particular property attached to it. I'm thinking option chaining would be appropriate, here.
