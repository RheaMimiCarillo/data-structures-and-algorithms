...
converting each element into strings,
...
now, the default behavior is inconvenient, so we can pass a callback function into .sort() to define the sort order
syntax:
  sort((a,b =>
  {
...
to define what which comes before the other:
