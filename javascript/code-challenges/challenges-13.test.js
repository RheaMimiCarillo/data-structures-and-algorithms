...
/*
  ...
  AKA, is this value in this array?

  // every
  let array = [6,674,1234,54,8]
  // know true of false if something is true about allllll of these values


  let isNum = array.every(num => typeof(num) === 'number');

  // is every number greater than 5?
  let higherThanFive = array.every(num => num > 5);
...
const standardizePhoneNumbers = (arr) =>
{
  ...
  return arr.map(num =>
  {
    return `${num.substring(1,4)}${num.substring(6,9)}${num.substring(10)}`;
  });
};
